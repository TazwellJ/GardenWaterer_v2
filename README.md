...
The sensors and relay board use the I2C protocol to commumicate so you could expand this up to 100+ devices with appropriate power supply, relay boards and I2C multiplexors.
